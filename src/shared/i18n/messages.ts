...
export const messages: Record<Locale, Messages> = {
  ...
  pl: {
    ...
    homeCalcTrust3Desc: 'Sprawdzamy wniosek i ostateczną kwotę',
    homeScenarioHero: 'Hero',
    ...
    homeHowLead: 'Od wyboru samochodu z USA, poprzez aukcje Copart i IAAI, aż po dostawę pojazdu do Twojego miasta.',
    homeHowAct: 'Etap',
    homeStep1Title: 'Brief i budżet',
    homeStep1Desc: 'Określamy zakres zadania, terminy oraz orientacyjny budżet',
    homeStep2Title: 'Wybór i weryfikacja',
    homeStep2Desc: 'Numer VIN, historia i zdjęcia przed opublikowaniem ogłoszenia',
    homeStep3Title: 'Aukcja i zakup',
    homeStep3Desc: 'Bezpieczna oferta i oficjalny zakup samochodu',
    homeStep4Title: 'Dostawa i opłaty',
    homeStep4Desc: 'Kontener, logistyka i odprawy',
    homeStep5Title: 'Wydanie kluczyków',
    homeStep5Desc: 'Samochód z kompletem dokumentów',
    homeHowCta: 'Chcesz obliczyć cenę samochodu w domu?',
