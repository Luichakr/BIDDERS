        ...
        <div className="px-header__bar">
          ...
          <div className="px-header__social" aria-label={t('headerSocialAria')}>
            ...
            <a href="https://m.me/bidbidders" target="_blank" rel="noopener noreferrer" aria-label="Messenger">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M12 2C6.48 2 2 6.26 2 11.5c0 2.85 1.31 5.4 3.38 7.14V22l3.1-1.7c.83.23 1.7.35 2.62.35 5.52 0 10-4.26 10-9.5S17.52 2 12 2zm1.02 12.78l-2.54-2.72-4.96 2.72 5.46-5.78 2.6 2.72 4.9-2.72-5.46 5.78z"/>
              </svg>
            </a>
          </div>
