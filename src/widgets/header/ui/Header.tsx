    ...
    <>
      <header className={scrolled ? 'px-header scrolled' : 'px-header'}>
        <div className="px-header__bar">
          ...
          <nav className="px-header__nav" aria-label={t('headerPrimaryNavAria')}>
            ...
            <NavLink to={routes.inStock}>{t('navInStock')}</NavLink>
            <NavLink to={routes.blog}>{t('navBlog')}</NavLink>
            <NavLink to={routes.faq}>FAQ</NavLink>
            <NavLink to={routes.contacts}>{t('navContacts')}</NavLink>
          </nav>
      ...
      <nav className={mobileOpen ? 'px-mobile open' : 'px-mobile'} aria-label={t('headerMobileNavAria')}>
        ...
        <div className="px-mobile__links">
          ...
          <NavLink to={routes.inStock} onClick={closeMobile}>{t('navInStock')}</NavLink>
          ...
          <NavLink to={routes.blog} onClick={closeMobile}>{t('navBlog')}</NavLink>
          <NavLink to={routes.cases} onClick={closeMobile}>{t('navCases')}</NavLink>
          <NavLink to={routes.faq} onClick={closeMobile}>FAQ</NavLink>
          <NavLink to={routes.contacts} onClick={closeMobile}>{t('navContacts')}</NavLink>
        </div>
